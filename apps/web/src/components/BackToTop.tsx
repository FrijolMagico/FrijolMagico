...
export const BackToTop = () => {
  ...
  return (
    <button
      ...
      } bg-secondary text-background transition-150 fixed bottom-8 left-8 z-50 aspect-square w-10 transform-gpu rounded-full transition-[transform,opacity] hover:scale-105`}
