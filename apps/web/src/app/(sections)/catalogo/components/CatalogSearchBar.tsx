...
export const CatalogSearchBar = () => {
  ...
  return (
    <input
      ...
      className='border-primary/30 focus:ring-primary/50 text-foreground h-8 w-full max-w-md rounded-xl border border-dashed px-3 text-sm focus:border-transparent focus:ring-2 focus:outline-none'
    />
  )
}
