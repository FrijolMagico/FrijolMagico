...
-- Tablas: evento_edicion_participante, participante_exposicion, participante_actividad, actividad
-- ============================================
...
CREATE TABLE IF NOT EXISTS evento_edicion_participante (
    ...
    CONSTRAINT chk_participante_modo_ingreso CHECK (modo_ingreso IN ('seleccion', 'invitacion')),
    CONSTRAINT chk_participante_estado CHECK (estado IN ('seleccionado', 'confirmado', 'cancelado', 'no_asistio'))
);
...
CREATE INDEX IF NOT EXISTS idx_participante_modo_ingreso ON evento_edicion_participante (modo_ingreso);
...
CREATE TABLE IF NOT EXISTS participante_exposicion (
    ...
    CONSTRAINT fk_exposicion_participante FOREIGN KEY (participante_id)
        REFERENCES evento_edicion_participante (id) ON DELETE CASCADE,
    CONSTRAINT fk_exposicion_disciplina FOREIGN KEY (disciplina_id)
        REFERENCES disciplina (id),
    CONSTRAINT fk_exposicion_agrupacion FOREIGN KEY (agrupacion_id)
        REFERENCES agrupacion (id),
    CONSTRAINT uq_exposicion_participante UNIQUE (participante_id),
    CONSTRAINT chk_exposicion_estado CHECK (estado IN ('seleccionado', 'confirmado', 'cancelado', 'no_asistio'))
);
...
CREATE TABLE IF NOT EXISTS participante_actividad (
    ...
    CONSTRAINT fk_actividad_participante FOREIGN KEY (participante_id)
        REFERENCES evento_edicion_participante (id) ON DELETE CASCADE,
    CONSTRAINT fk_actividad_tipo FOREIGN KEY (tipo_actividad_id)
        REFERENCES tipo_actividad (id),
    CONSTRAINT fk_actividad_agrupacion FOREIGN KEY (agrupacion_id)
        REFERENCES agrupacion (id),
    CONSTRAINT chk_actividad_estado CHECK (estado IN ('seleccionado', 'confirmado', 'cancelado', 'no_asistio'))
);
...
CREATE TABLE IF NOT EXISTS actividad (
    ...
    CONSTRAINT fk_actividad_participante_actividad FOREIGN KEY (participante_actividad_id)
        REFERENCES participante_actividad (id) ON DELETE CASCADE,
