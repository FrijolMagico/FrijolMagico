...
export const FestivalTimelineCard = ({
  ...
  console.log({ id: evento.id, nombre: evento.nombre })
  return (
    <article
      className={cn(
        'group bg-fm-white outline-fm-black/20 flex w-full max-w-2xl flex-col overflow-hidden rounded-4xl shadow-lg outline transition-all duration-300 outline-dashed hover:shadow-xl',
